...
HD_PWD='C:/Users/ilili/Downloads/template2/template/vivado/Example_Project/axi_mult_adder/axi_fnd_mult_adder/axi_fnd_mult_adder.runs/design_1_multadder_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_multadder_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_multadder_0_0.tcl
